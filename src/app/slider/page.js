...
export default function Mailbox() {
  return (
    <Box bg="white" minH="100vh" w="full" position="relative" color="black" paddingBottom={{ base: "10vh", md: "20vh" }}>
      ...
      <Box h={{ base: "auto", md: "100vh" }} w="full" position="relative" pt={{ base: "120px", md: "0" }} pb={{ base: "40px", md: "0" }}>
        ...
        >
          <Box position="relative" w="full" h="full">
            <Image
              src="/images/machine/DSC_3305.jpg"
              alt="Mailbox Hero"
              fill
      ...
      <DetailSection 
        imageSrc="/images/machine/DSC_3389.jpg"
        alt="Mailbox Detail 1"
        caption="the slider lengthens the belt -- an indication of making the data processing pipeline longer by adding more Perceptron layers into a model"
      />

      <DetailSection 
        imageSrc="/images/machine/DSC_3357.jpg"
        alt="Mailbox Detail 1"
        caption="the top surface of the slider knob reveals the touch pad electrode to make evident that it can be touched."
      />
      <MachineIndex/>
    </Box>
  );
