  ...
  return (
      ...
      <Box h="100vh" w="full" position="relative">
        ...
        >
          <VStack align="start" gap="48px">
            ...
            >
              ...
              <br />
              <Span textDecoration="line-through">unconditional trust</Span>
            </Text>
          </VStack>
        </Box>
        ...
        >
          <Box position="relative" w="full" h="full">
            <Image
              src="/images/machine/DSC_3297.jpg"
              alt="Mailbox Hero"
              fill
    ...
    >
      <iframe
        width="100%"
        height="100%"
        src="https://www.youtube.com/embed/Qv2Z-K0fyPo"
      ...
      <DetailSection 
        imageSrc="/images/machine/DSC_3363.jpg"
        alt="Mailbox Detail 1"
        caption="the design of the scroll wheel references the emergency stop buttons in industrial machineries"
      />
      <MachineIndex/>
    </Box>
  );
