  ...
  return (
      ...
      <Box h="100vh" w="full" position="relative">
        ...
        >
          <VStack align="start" gap="48px">
            ...
            >
              ...
              <br />
              <Span textDecoration="line-through">cognitive surrender</Span>
            </Text>
          </VStack>
        </Box>
        ...
        >
          <Box position="relative" w="full" h="full">
            <Image
              src="/images/machine/DSC_3192.jpg"
              alt="Mailbox Hero"
              fill
    ...
    >
      <iframe
        width="100%"
        height="100%"
        src="https://www.youtube.com/embed/AnHrHDyPBy0"
      ...
      <DetailSection 
        imageSrc="/images/machine/DSC_3245.jpg"
        alt="Mailbox Detail 1"
        caption="the slot machine uses the metaphor of gambling to highlight the probabilistic nature of language models"
      />

      <DetailSection 
        imageSrc="/images/machine/DSC_3202.jpg"
        alt="Mailbox Detail 1"
      />
      <MachineIndex/>
    </Box>
